        ...
        <div className="container">
            <div className="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
                ...
                <div className="text-white mt-10 lg:mt-0">
                    ...
                    <div className="intro-x text-xl lg:text-3xl font-medium mt-5">Oops. Halaman tidak ditemukan.</div>
                    <div className="intro-x text-lg mt-3">Anda tidak dapat mengakses halaman ini.</div>
