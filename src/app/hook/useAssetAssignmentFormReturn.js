...
import { getAssetAssignmentById, ReturnAssetAssignment } from "../services/assetAssignment";

export const useAssetAssignmentFormReturn = (id) => {
  ...
  const requiredFields = ["tanggal_pengembalian", "kondisi_saat_pengembalian"];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await ReturnAssetAssignment(id, newFormData);
