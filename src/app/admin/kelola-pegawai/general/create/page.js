...
import { useGeneralFormCreate } from "@/app/hook/useGeneralFormCreate";
...
const CreateGeneral = () => {
  const { 
    ...
    handleFileChange,
    handleSubmit, 
  } = useGeneralFormCreate();
  return (
    <Dashboard>
      <div className="content">
        <div className="intro-y box py-5 sm:py-10 mt-5">
          <div className="px-5 my-10">
            <div className="font-medium text-center text-lg">Tambah Pegawai</div>
          ...
          <div className="px-5 sm:px-20 pt-10 border-t border-slate-200/60 dark:border-darkmode-400">
            ...
            <form encType="multipart/form-data" onSubmit={handleSubmit}>
              <div className="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                ...
                <div className="intro-y col-span-12 sm:col-span-6 mb-4">
