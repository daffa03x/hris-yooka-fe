...
import { useKontrakFormEdit } from "@/app/hook/useKontrakFormEdit";
import Dashboard from "@/app/layouts/AdminDashboard";
import { useParams } from "next/navigation";

const EditKontrak = () => {
  const { id } = useParams();
  const { formData, error, loading, submitButton, options, handleChange, handleSubmit, handlePegawaiChange } = useKontrakFormEdit(id);
      ...
      <div className="content">
        <div className="intro-y box py-5 sm:py-10 mt-5">
          <div className="px-5 my-10">
            <div className="font-medium text-center text-lg">Edit Kontrak Pegawai</div>
