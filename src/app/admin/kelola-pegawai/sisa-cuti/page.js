...
import { deleteSisaCuti, generateSisaCutiAll, getSisaCuti } from "@/app/services/pegawaiSisaCuti";
  ...
  return (
    <Dashboard>
      <div className="content">
        <h2 className="intro-y text-lg font-medium mt-10">Data Cuti Tahunan</h2>
        <div className="grid grid-cols-12 gap-6 mt-5">
          <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            {/* <LinkButton classNameLink="btn btn-primary mr-3" classNameLoading="btn btn-primary" link="/admin/kelola-pegawai/sisa-cuti/create" title="Tambah Cuti Tahunan"/> */}
            ...
            <table className="table table-report w-full">
              <thead>
                <tr>
                  ...
                  <th className="whitespace-nowrap">Sisa Cuti</th>
                  <th className="whitespace-nowrap">Tahun</th>
                ...
                {loading ? (
                  ...
                  data.map((item, index) => (
                    <tr className="intro-x" key={index}>
                      ...
                      <td className="whitespace-nowrap">{item.pegawais.users.name}</td>
                      <td className="whitespace-nowrap">{item.sisa_cuti}</td>
                      <td className="whitespace-nowrap">{item.tahun}</td>
                      <td className="table-report__action w-56">
                        <div className="flex justify-center items-center">
                          <EditButton link={`/admin/kelola-pegawai/sisa-cuti/edit/${item.id}`} />
