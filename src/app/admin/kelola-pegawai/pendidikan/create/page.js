...
import { usePendidikanFormCreate } from "@/app/hook/usePendidikanFormCreate";
import Dashboard from "@/app/layouts/AdminDashboard";

const CreatePendidikan = () => {
  const { formData, error, loading, submitButton, options, handleChange, handleSubmit, handleFileChange, handlePegawaiChange } = usePendidikanFormCreate();
  if (loading) {
    return (
      <Dashboard>
        <Loading />
      ...
      <div className="content">
        <div className="intro-y box py-5 sm:py-10 mt-5">
          <div className="px-5 my-10">
            <div className="font-medium text-center text-lg">Tambah Pendidikan Pegawai</div>
          ...
          <div className="px-5 sm:px-20 pt-10 border-t border-slate-200/60 dark:border-darkmode-400">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="intro-y col-span-12 sm:col-span-6 mt-4 mb-5"></div>
