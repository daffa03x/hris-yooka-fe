...
import { useAssetMaintenanceFormCreate } from "@/app/hook/useAssetMaintenanceFormCreate";
import Dashboard from "@/app/layouts/AdminDashboard";
import { useState } from "react";

const CreateAssetMaintenance = () => {
    const { formData, error, loading, submitButton, options, handleChange, handleSubmit, handleAssetChange } = useAssetMaintenanceFormCreate();
    ...
    const handleCurrencyChange = (e) => {
        ...
        // Only allow digits
        if (/^\d*$/.test(rawValue)) {
            // Keep the original formatted value in formData.harga
        ...
        <Dashboard>
            <div className="content">
                ...
                <div className="px-5 my-10">
                    <div className="font-medium text-center text-lg">Tambah Perbaikan Asset</div>
                ...
                <div className="px-5 sm:px-20 pt-10 border-t border-slate-200/60 dark:border-darkmode-400">
                    ...
                    <div className="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                        ...
                        <SelectReact name="id_asset" options={options} value={formData.id_asset} onChange={handleAssetChange} isEdit={false} defaultValue={null} />
                        </div>
                        <div className="intro-y col-span-12 sm:col-span-6">
