...
import { deleteAssetAssignment, getAssetAssignment } from "@/app/services/assetAssignment";
...
const AssetAssignment = () => {
  ...
  const { 
    ...
    handlePerPageChange, 
    handleDelete, 
  } = useGetData(getAssetAssignment, deleteAssetAssignment);
  ...
  return (
    <Dashboard>
            ...
            <div className="overflow-x-auto">
              <div className="flex flex-wrap gap-8 w-full">
                ...
                <div className="flex-1 min-w-[250px] sm:min-w-[300px]">
                  <h4 className="text-lg font-semibold mb-2 px-5">Tanggal Peminjaman</h4>
                  <DateRangePicker
                    onChange={(item) => {
      ...
      <div className="content">
        <h2 className="intro-y text-lg font-medium mt-10">Data Peminjaman Asset</h2>
        <div className="grid grid-cols-12 gap-6 mt-5">
          <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <LinkButton classNameLink="btn btn-primary" classNameLoading="btn btn-primary" link="/admin/inventaris/asset-assignment/create" title="Tambah Peminjaman Asset"/>
            ...
            <table className="table table-report w-full">
              <thead>
                <tr>
                  ...
                  <th className="whitespace-nowrap">Pengembalian Asset</th>
                  ...
                  data.map((item, index) => (
                    <tr className="intro-x" key={index}>
                        ...
                        <td className="whitespace-nowrap">
                            <Link href={`/admin/inventaris/asset-assignment/asset-return/${item.id}`} className="btn btn-outline-secondary">Kembalikan Asset</Link>
                        </td>
                        <td className="table-report__action w-56">
                        <div className="flex justify-center items-center">
                            <EditButton link={`/admin/inventaris/asset-assignment/edit/${item.id}`} />
