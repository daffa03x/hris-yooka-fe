...
import { useAssetAssignmentFormReturn } from "@/app/hook/useAssetAssignmentFormReturn";
import Dashboard from "@/app/layouts/AdminDashboard";
import { useParams } from "next/navigation";

const ReturnAssetAssignment = () => {
    const { id } = useParams();
  const { formData, error, loading, submitButton, handleChange, handleSubmit } = useAssetAssignmentFormReturn(id);
  if (loading) {
    return (
      <Dashboard>
        <Loading />
      ...
      <div className="content">
        <div className="intro-y box py-5 sm:py-10 mt-5">
          <div className="px-5 my-10">
            <div className="font-medium text-center text-lg">Pengembalian Asset</div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                <div className="intro-y col-span-12 sm:col-span-6">
                    ...
                    <input type="date" id="tanggal_pengembalian" className="form-control" value={formData.tanggal_pengembalian} onChange={(e) => handleChange("tanggal_pengembalian", e)} step="1" required/>
                </div>
                ...
                <div className="intro-y col-span-12 sm:col-span-6">
                    ...
                    <textarea rows={4} cols={4} id="kondisi_saat_pengembalian" className="form-control" value={formData.kondisi_saat_pengembalian} onChange={(e) => handleChange("kondisi_saat_pengembalian", e)} step="1" required></textarea>
                </div>
                <div className="intro-y col-span-12 sm:col-span-6">
...
export default ReturnAssetAssignment;
