...
import { useAssetFormCreate } from "@/app/hook/useAssetFormCreate";
import Dashboard from "@/app/layouts/AdminDashboard";
import { useState } from "react";

const CreateAsset = () => {
  const { formData, error, loading, submitButton, options, handleChange, handleSubmit, handleKategoriChange } = useAssetFormCreate();
  ...
  const handleCurrencyChange = (e) => {
      ...
      if (/^\d*$/.test(rawValue)) {
          ...
          // Update formData dengan nilai terformat untuk tampilan
      ...
      <div className="content">
        <div className="intro-y box py-5 sm:py-10 mt-5">
          <div className="px-5 my-10">
            <div className="font-medium text-center text-lg">Tambah Asset</div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                ...
                <div className="intro-y col-span-12 sm:col-span-6">
                  ...
                  <SelectReact name="id_kategori" options={options} value={formData.id_kategori} onChange={handleKategoriChange} isEdit={false} defaultValue={null} />
                </div>
                <div className="intro-y col-span-12 sm:col-span-6">
