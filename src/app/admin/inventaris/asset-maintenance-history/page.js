...
import { getAssetMaintenanceHistory } from "@/app/services/assetMaintenanceHistory";
...
const AssetMaintenanceHistory = () => {
  ...
  const { 
    ...
    handlePageChange, 
    handlePerPageChange, 
  } = useGetData(getAssetMaintenanceHistory,);
  ...
  return (
    <Dashboard>
      ...
      <div className="content">
        <h2 className="intro-y text-lg font-medium mt-10">Data Perbaikan Asset History</h2>
